...
template <class T>
class UpperTraingular : public Matrix<T>{
    public:
     /**
     ...
     * to compromise
     */
    UpperTraingular(const int n,const bool accuracy = false):
     ...
     * @param value - the val we change to
     */
